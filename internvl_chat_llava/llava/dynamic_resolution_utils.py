...
def dynamic_preprocess(image: ImageFile, min_num: int = 1, max_num: int = 12, image_size=448, use_thumbnail: bool = False):
...
def load_image(image_file: Union[str | PosixPath], input_size: int = 448, min_num: int = 1, max_num: int = 12, use_thumbnail: bool = True):
